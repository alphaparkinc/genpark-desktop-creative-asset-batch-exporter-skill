# genpark-desktop-creative-asset-batch-exporter-skill
...
> **GenPark AI Agent Skill** -- Multi-agent desktop creative workflow scheduler & batch asset exporter (Omniwork style)
